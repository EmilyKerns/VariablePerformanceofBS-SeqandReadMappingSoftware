...
3. Call methylation: Scripts for calling methylation with Bismark are included. Methylation calling for all other read mapping methods was done using MethylDackel, which can also be used to filter SNPs.
